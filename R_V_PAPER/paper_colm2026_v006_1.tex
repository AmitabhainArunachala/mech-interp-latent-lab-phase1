% R_V Paper v006.1 — COLM 2026 Submission
...
%   - corrected framing: necessity yes, blunt sufficiency no
...
(L5H29: $\dcohen_{\mathrm{rank}} = +0.94$; L27H10: $\dcohen_{\mathrm{rank}} = -1.32$).
...
The last column is a qualitative placeholder; the locked claims in this draft are the numeric rank and stability values.
\end{table}
