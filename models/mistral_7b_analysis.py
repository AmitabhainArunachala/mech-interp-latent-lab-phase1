#!/usr/bin/env python3
"""
Mistral-7B-Instruct L4 Contraction Analysis
Original discovery model - October 2024
Effect: 15.3% contraction
"""
...
def run_mistral_analysis(prompts: Dict[str, List[str]], output_path: str = "mistral_7b_results.csv"):
    """
    Run complete Mistral-7B analysis on provided prompts.
    ...
    """
    print("=" * 50)
    print("MISTRAL-7B L4 CONTRACTION ANALYSIS")
    print("=" * 50)
    ...
    if 'L5_recursive' in group_stats.index and 'factual_baseline' in group_stats.index:
        ...
        if effect > 5:
            print(f"  ✅ Mistral exhibits significant L4 contraction!")
...
if __name__ == "__main__":
    # Example usage with a few test prompts
    test_prompts = {
        'L5_recursive': [
    ...
    results = run_mistral_analysis(test_prompts)
    print("\n✅ Mistral-7B analysis complete!")
