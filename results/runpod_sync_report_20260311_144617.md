...
**Generated**: 2026-03-11 05:46:17 UTC
...
| 8 | Dual layer: R_V transfer d (geometry-behavior dissociation) | 0.11 | 3.82 | **NO** -- Paper claims R_V geometry does NOT transfer (d=0.11, NS). |
...
- **Dual layer: session-level Cohen's d (break)**: Paper says `3.29`, data shows `4.64`.
  - Action: Investigate whether this is a new run, different prompt set, or genuine discrepancy.
- **Dual layer: R_V transfer d (geometry-behavior dissociation)**: Paper says `0.11`, data shows `3.82`.
  - Note: Paper claims R_V geometry does NOT transfer (d=0.11, NS).
  - Action: Investigate whether this is a new run, different prompt set, or genuine discrepancy.
