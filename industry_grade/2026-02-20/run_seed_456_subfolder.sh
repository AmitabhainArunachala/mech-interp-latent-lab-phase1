...
MATRIX="$REPO_ROOT/configs/canonical/seed_bridge_2026_02_20/seed_456/RUN_MATRIX.csv"
LOG_DIR="$REPO_ROOT/industry_grade/2026-02-20/evidence/seed_456_subfolder_logs"
STATUS_FILE="$REPO_ROOT/industry_grade/2026-02-20/evidence/seed_456_subfolder_status.csv"
...
echo "Completed seed_456 subfolder pass."
