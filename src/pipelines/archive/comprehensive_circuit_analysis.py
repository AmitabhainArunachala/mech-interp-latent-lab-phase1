...
def run_comprehensive_analysis(
    ...
    # Prompt bank hygiene (DEC15): all prompts come from prompts/bank.json and we log the bank hash
    loader = PromptLoader()
    ...
    # Define prompts (sealed bank ids; no hardcoded prompt strings)
    ...
    results["dose_response"] = {"prompt_ids": dose_prompt_ids, "results": dose_results}
